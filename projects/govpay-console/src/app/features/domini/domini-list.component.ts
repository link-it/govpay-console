...
export class DominiListComponent implements OnInit {
  ...
  readonly searchFields = computed<SearchField[]>(() => {
    ...
    return [
      { id: F.idDominio, label: t('Domini.Filters.IdDominio'), kind: 'text', placeholder: t('Domini.Filters.IdDominioPlaceholder'), span: 2 },
      { id: F.ragioneSociale, label: t('Domini.Filters.RagioneSociale'), kind: 'text', placeholder: t('Domini.Filters.RagioneSocialePlaceholder'), span: 2 },
      {
        id: F.abilitato,
