...
export const AREE_IMPOSTAZIONI: readonly AreaImpostazioniDef[] = [
  ...
  { codice: 'mailTemplate', route: 'mail-template', labelKey: 'Impostazioni.Aree.MailTemplate.Nome', descKey: 'Impostazioni.Aree.MailTemplate.Desc', icon: 'bootstrapEnvelopePaper', built: false },
  ...
  { codice: 'appIoTemplate', route: 'app-io-template', labelKey: 'Impostazioni.Aree.AppIoTemplate.Nome', descKey: 'Impostazioni.Aree.AppIoTemplate.Desc', icon: 'bootstrapChatDots', built: false },
  { codice: 'tracciatoCsv', route: 'tracciati-csv', labelKey: 'Impostazioni.Aree.TracciatiCsv.Nome', descKey: 'Impostazioni.Aree.TracciatiCsv.Desc', icon: 'bootstrapFileEarmarkCode', built: false },
